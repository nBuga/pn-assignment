 ...
 */
final class Version20240527120046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prize (id INT AUTO_INCREMENT NOT NULL, partner_id INT NOT NULL, code VARCHAR(255) NOT NULL, stock INT NOT NULL, INDEX IDX_51C88BC1E0309D0A (partner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
