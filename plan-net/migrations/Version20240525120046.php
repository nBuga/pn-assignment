...
final class Version20240525120046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prize (id INT AUTO_INCREMENT NOT NULL, partner_code_id INT NOT NULL, code VARCHAR(255) NOT NULL, INDEX IDX_51C88BC1E0309D0A (partner_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE prize ADD CONSTRAINT FK_51C88BC1E0309D0A FOREIGN KEY (partner_code_id) REFERENCES partner (id)');
